  ...
  async execute(client, message) {
    const guildMemberPresence = async () => {
      ...
      await message.guild.members.fetch().then((fetchedMembers) => {
        ...
        str = `<:online:794157545244852244>: ${totalOnline} <:dnd:794157544552923136>: ${totalDnd} <:idle:794157544397340702>: ${totalIdle} (Total: ${
    ...
    const explicitContentObj = {
      ...
      MEMBERS_WITHOUT_ROLES:
        "<:greenTick:792047523803299850> Members without roles",
    ...
    const embed = new MessageEmbed()
      ...
      .addField(
        "Guild Owner",
        `<:owner:794192802178793483> ${message.guild.owner} (${message.guild.ownerID})`,
        false
      )
      .addField(
        "Guild Creation Date",
      ...
      .addField(
        ...
        explicitContentObj[message.guild.explicitContentFilter],
        false
      )
      .addField("2FA Moderation", factorModeration, false)
      .addField(
        "Verification Level",
        verificationLevelObj[message.guild.verificationLevel],
        false
      );
