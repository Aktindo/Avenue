...
module.exports = {
	...
	async execute(client, message, args) {
		...
		const BADGES = {
			'DISCORD_EMPLOYEE': '<:DiscordStaff:810164713065283694> | Discord Staff',
			'DISCORD_PARTNER': '<:DiscordPartner:810164035319496725> | Discord Partner',
			'BUGHUNTER_LEVEL_1': '<:BugHunter:810164035273228290> | BugHunter Level 1',
			'HYPESQUAD_EVENTS': '<:HypeSquadEvents:810164035034284072> | Hypesquad Events',
			'HOUSE_BRAVERY': '<:HypeSquadBravery:810164036452483112> | Hypesquad Bravery',
			'HOUSE_BRILLIANCE': '<:HypeSquadBrilliance:810164035231809577> | Hypesquad Brilliance',
			'HOUSE_BALANCE': '<:HypeSquadBalance:810164035022487623> | Hypesquad Balance',
			'EARLY_SUPPORTER': '<:EarlySupporter:810164033461420052> | Early Supporter',
			'VERIFIED_BOT': '<:Verified:810164034983952454> | Verified Bot',
			'VERIFIED_DEVELOPER': '<:Verified:810164034983952454> | Early Verified Bot Developer',
		};
		...
		let messageCount = messageCountRes ? messageCountRes.messageCount : 0;
		...
		const userinfo = new MessageEmbed()
			...
			.addField(`Roles [${member.roles.cache.size - 1}]`, roles.length < 10 ? roles.join(', ') : roles.length > 10 ? trimArray(roles).join(', ') : 'None', false)
