...
router.get('/invite', (req, res) => {
  res.redirect(`https://discord.com/api/oauth2/authorize?client_id=${process.env.clientId}&redirect_uri=${process.env.dashboardURL}/auth&response_type=code&scope=bot`)
})
