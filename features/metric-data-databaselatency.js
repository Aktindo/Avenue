const userMessagecountModel = require('../models/user-messagecount-model');
module.exports = async (client) => {
    ...
    const datePrevious = Date.now()
    const data = await userMessagecountModel.find({})
    const dateNow = Date.now()
    const latency = dateNow - datePrevious
